...
public class AuthService {
    ...
    public AuthService(
        ...
        @Value("${DEFAULT_RESET_PASSWORD:Football2026!}") String defaultResetPassword
    ) {
    ...
    public PasswordResetResponse resetUserPasswordByAdmin(Long actorUserId, Long targetUserId) {
        ...
        targetUser.setPasswordHash(passwordEncoder.encode(defaultResetPassword));
        ...
        return new PasswordResetResponse(saved.getId(), saved.getEmail(), saved.isMustChangePassword(), defaultResetPassword);
    }
